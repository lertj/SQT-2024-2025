...
import en.ase.acs.patterns.adapter.object.v2.concretes.MyTextEditor;
import en.ase.acs.patterns.adapter.object.v2.concretes.NotepadPlusPlusEditor;
...
public class Main {
    public static void main(String[] args) {
        ...
        String[] textArr = new String[]{"This", "is", "Notepad", "Plus", "Plus"};
        NotepadPlusPlusEditor plusEditor = new NotepadPlusPlusEditor(textArr);
